...
namespace Likes.Com_BOT
{
    class Spinner
    {
        ...
        public static int SpinEvenMoreFasterInner(String text, int start, long end, int symbolIndex)
        {
            ...
            text.CopyTo(last, symbolsOfTextProcessed, symbolIndex, (int)end - last);

            return symbolIndex + (int)end - last;
